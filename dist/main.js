...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_app_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/app.scss */ \"./src/styles/app.scss\");\n/* harmony import */ var _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/DOMElements */ \"./src/utils/DOMElements/index.js\");\n/* harmony import */ var _components_Header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Header */ \"./src/components/Header/index.js\");\n/* harmony import */ var _models_Project__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/Project */ \"./src/models/Project/index.js\");\n/* harmony import */ var _models_Todo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/Todo */ \"./src/models/Todo/index.js\");\n/* harmony import */ var _views_TodoList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/TodoList */ \"./src/views/TodoList/index.js\");\n/* harmony import */ var _views_ProjectList__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/ProjectList */ \"./src/views/ProjectList/index.js\");\n/* harmony import */ var _components_Form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/Form */ \"./src/components/Form/index.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst ListController = (function () {\r\n  const add = (project, item) => {\r\n    project.addItem(item.getInfo());\r\n  };\r\n\r\n  const read = () => {\r\n    projects = JSON.parse(localStorage.getItem('projects'));\r\n    if (projects === null) {\r\n      projects = [];\r\n      let defaultProject = (0,_models_Project__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('Untitled');\r\n      projects.push(defaultProject);\r\n    } else {\r\n      for (let i in projects) {\r\n        projects[i] = (0,_models_Project__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(projects[i].title, projects[i].items);\r\n      }\r\n    }\r\n    if (_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].listContainer() !== null) {\r\n      _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].listContainer().remove();\r\n    }\r\n    _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].todoList().insertAdjacentHTML(\r\n      'beforeend',\r\n      (0,_views_TodoList__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(projects[0].getInfo())\r\n    );\r\n  };\r\n\r\n  const save = () => {\r\n    let userData = [];\r\n    for (let i in projects) {\r\n      userData.push(projects[i].getInfo());\r\n    }\r\n    localStorage.setItem('projects', JSON.stringify(userData));\r\n  };\r\n\r\n  return { add, read, save };\r\n})();\r\n\r\nlet projects = [];\r\nListController.read();\r\nListController.save();\r\n\r\n_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].todoList().insertAdjacentHTML('afterbegin', (0,_components_Header__WEBPACK_IMPORTED_MODULE_2__[\"default\"])());\r\n_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].projects().insertAdjacentHTML('afterbegin', (0,_views_ProjectList__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(projects));\r\n_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].firstProject().classList.add('project-list--active');\r\n_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].h1().innerText = _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].currentProject().innerText;\r\n\r\n// Handle form input and create a new todo\r\nfunction handleSubmit() {\r\n  _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].formSubmitBtn().addEventListener('click', (event) => {\r\n    event.preventDefault();\r\n    const input = _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getFormInput();\r\n    const newItem = (0,_models_Todo__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(\r\n      input.title,\r\n      input.description,\r\n      input.date,\r\n      input.priority,\r\n      input.notes,\r\n      input.checklist\r\n    );\r\n\r\n    ListController.add(projects[0], newItem);\r\n    ListController.save();\r\n    ListController.read();\r\n    _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].form().remove();\r\n    _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].overlay().remove();\r\n  });\r\n}\r\n\r\n// Display form to add new items\r\n_utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].newTodoBtn().addEventListener(\r\n  'click',\r\n  () => {\r\n    _utils_DOMElements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].todoList().insertAdjacentHTML('beforeend', (0,_components_Form__WEBPACK_IMPORTED_MODULE_7__[\"default\"])());\r\n    handleSubmit();\r\n  },\r\n  false\r\n);\r\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
